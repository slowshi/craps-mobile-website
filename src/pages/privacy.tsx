export default function Privacy() {
  return (
    <div className="font-sans p-4">
      <strong className="text-xl block mb-4">Privacy Policy</strong>
      <p className="mb-2">
        Len Lester built the Craps Mobile app as a Free app. This SERVICE is provided by Len Lester at no cost and is
      ...
      <p className="mb-2">
        ...
        accessible at Craps Mobile unless otherwise defined in this Privacy Policy.
      </p>
      <p className="mb-2">
        <strong className="block mb-2">Third-Party Services</strong>
      </p>
      <p className="mb-2">
      ...
      <div className="mb-4">
        <p className="mb-2">The app does use third-party services that may collect information used to identify you.</p>
        <p className="mb-2">Link to the privacy policy of third-party service providers used by the app</p>
      ...
      <p className="mb-2">I may employ third-party companies and individuals due to the following reasons:</p>
      <ul className="list-disc pl-6">
      ...
      <p className="mb-2">This policy is effective as of 2023-08-30</p>
      <p className="mb-2">
